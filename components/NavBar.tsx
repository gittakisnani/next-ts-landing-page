...
const NavBar = ({ handleNavBar } : { handleNavBar: () => void}) => {
  ...
  return (
    <nav className="fixed top-0 bottom-0 z-[1000] right-0 w-[70%] md:w-fit md:static flex flex-col md:flex-row gap-4 md:gap-8 md:items-center bg-white p-8 md:p-0 text-xl md:text-base ">
      {width! < 768 && 
